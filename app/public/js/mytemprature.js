$(function() {
    ...
    $.ajax({
        ...
        $( '.deletemeasurment').on('click', function(e){
        ...
        function showMeasurements(data) {
            output += '<div class = "deletemeasurment">'; 
            output += '<tr>';
            output += '<th>ID</th>';
            output += '<th>DATE</th>';
     ...
     $.each(data,function(key, item) {
        ...
        output += '<th> <div class="media-left"><button class="feedback-delete btn btn-xs btn-danger"><span id="' + item.Id + '" class="glyphicon glyphicon-remove"></span></button></div> </th>';
        output += '</tr>';
        output += '</div>';
